...
- **Mistake**: Asked coreConvention "Would you rather start with native Python or Docker?" when the entire project was already set up for Docker and there was no reason to present alternatives. Created confusion.
- **Correction**: coreConvention said "I am confused by your question."
